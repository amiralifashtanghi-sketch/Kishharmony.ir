<?php
/**
 * Module 2: Internal Header (Central Fixed Logo, Glassmorphism Scroll, Hamburger & Icons)
 * Strictly implemented based on "ساختار کلی هدر.txt"
 */
...
<header class="header internal-header" id="header">
    <!-- 1. Left Area (Hamburger Button) -->
    ...
    <!-- 2. Center Area (Fixed Central Logo) -->
    ...
    <!-- 3. Right Area (Cart & Account Icons) -->
