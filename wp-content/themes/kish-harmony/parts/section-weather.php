<?php
/**
 * Kish Weather Widget Section Template Part (Glassmorphic)
 */
if (!defined('ABSPATH')) exit;
?>
<section class="weather-widget max-w-7xl mx-auto my-8 relative rounded-3xl p-6 sm:p-8 border border-white/40 shadow-lg bg-gradient-to-br from-sky-100/60 via-teal-50/40 to-[#18D6D8]/20 backdrop-blur-md">
